...
Define exactly what you trade: specific forex pairs (EUR/USD, GBP/USD), specific stocks (large caps, small caps), or specific crypto assets. Specializing allows you to learn the "personality" of your instruments.
...
- How you identify the trend (market structure criteria).
- What zones/levels you trade from (supply/demand, support/resistance).
...
- Maximum number of correlated positions open simultaneously.
